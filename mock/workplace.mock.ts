    ...
    data: [
      {
        ...
        title: titles[0],
        logo: avatars[0],
        description: 'That is something they cannot reach or touch internally',
        updatedAt: new Date(),
        member: 'Science Bricklaying Team',
        href: '',
        memberLink: '',
      },
      {
    ...
    data: [
      {
        ...
        group: {
          name: 'High Standard Design Team',
        ...
        template: 'Created project @{project} in group @{group}',
      },
      {
        id: 'trend-2',
        updatedAt: new Date(),
      ...
      },
      {
        ...
        template: 'Updated @{project} to published state',
      },
      {
        id: 'trend-5',
        updatedAt: new Date(),
