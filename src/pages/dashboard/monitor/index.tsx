    ...
    <GridContent>
      <>
            ...
            <Card title="Real-time Trading Activity" bordered={false}>
              <Row>
                <Col md={6} sm={12} xs={24}>
                  <Statistic
                    title="Today's Total Trading Volume"
                    suffix="CNY"
                ...
                <Col md={6} sm={12} xs={24}>
                  <Countdown title="Remaining Time of the Event" value={deadline} format="HH:mm:ss:SSS" />
                </Col>
                <Col md={6} sm={12} xs={24}>
                  <Statistic title="Trading Volume per Second" suffix="CNY" value={numeral(234).format('0,0')} />
                </Col>
              </Row>
        ...
        <Row gutter={24}>
          ...
          >
            <Card title="Proportion of Various Categories" bordered={false}>
              <Row
                style={{
                  padding: '16px 0',
                }}
